...
class CommonUtil {
    ...
    public static boolean checkPermissions(Context context, String permission) {
        if (context == null || permission.equals("") || permission.equals("")) {
            CobubLog.e(UTConstants.LOG_TAG, CommonUtil.class, "Incorrect parameters");
            return false;
        }
    ...
    public static String getUserIdentifier(Context context) {
        if (context == null) {
            CobubLog.e(UTConstants.LOG_TAG, CommonUtil.class, "context is null");
            return "";
        }
        if (USER_ID.equals("")) {
            SharedPrefUtil sp = new SharedPrefUtil(context);
    ...
    public static SendPolicy getReportPolicyMode(Context context) {
        ...
        switch (type) {
            case 0:
                UTAgent.setDefaultReportPolicy(context, SendPolicy.POST_ONSTART);
                break;
            case 1:
                UTAgent.setDefaultReportPolicy(context, SendPolicy.POST_NOW);
                break;
            case 2:
                UTAgent.setDefaultReportPolicy(context, SendPolicy.POST_INTERVAL);
                break;

            default:
                break;
        }
        return UTConstants.mReportPolicy;
    }
    ...
    public static boolean isNetworkAvailable(Context context) {
        ...
        if (checkPermissions(context, "android.permission.INTERNET")) {
            ...
            if (info != null && info.isAvailable()) {
                CobubLog.i(UTConstants.LOG_TAG, CommonUtil.class, "Network is available.");
                return true;
            } else {
                CobubLog.i(UTConstants.LOG_TAG, CommonUtil.class, "Network is not available.");
                return false;
            }

        } else {
            CobubLog.e(UTConstants.LOG_TAG, CommonUtil.class,
    ...
    static boolean isNewSession(Context context) {
        ...
        try {
            ...
            CobubLog.i(UTConstants.LOG_TAG, CommonUtil.class, "currenttime=" + currenttime);
            CobubLog.i(UTConstants.LOG_TAG, CommonUtil.class, "session_save_time=" + session_save_time);
            if (currenttime - session_save_time > getSessionContinueMillis(context)) {
                CobubLog.i(UTConstants.LOG_TAG, CommonUtil.class, "return true,create new session.");
                return true;
            }
            CobubLog.i(UTConstants.LOG_TAG, CommonUtil.class, "return false.At the same session.");
            return false;
        } catch (Exception e) {
            CobubLog.e(UTConstants.LOG_TAG, e);
            return true;
    ...
    public static boolean isNetworkTypeWifi(Context context) {
        ...
        if (checkPermissions(context, "android.permission.INTERNET")) {
            ...
            if (info != null && info.isAvailable()
                ...
                CobubLog.i(UTConstants.LOG_TAG, CommonUtil.class, "Active Network type is wifi");
                return true;
            } else {
                CobubLog.i(UTConstants.LOG_TAG, CommonUtil.class, "Active Network type is not wifi");
                return false;
            }
        } else {
            CobubLog.e(
                    UTConstants.LOG_TAG, CommonUtil.class,
    ...
    static long getSessionContinueMillis(Context context) {
        // UTConstants.kContinueSessionMillis
        SharedPrefUtil spu = new SharedPrefUtil(context);
    ...
    static boolean isUpdateOnlyWIFI(Context context) {
        ...
        return spu.getValue("updateOnlyWifiStatus",
                UTConstants.mUpdateOnlyWifi);

    }

    static boolean isSupportlocation(Context context) {
        SharedPrefUtil spu = new SharedPrefUtil(context);
        return spu.getValue("locationStatus", UTConstants.mProvideGPSData);
    }
    ...
    static JSONArray getJSONdata(String cachfileclientdata, String key) {
        ...
        if (data.length() > 0) {
            String[] dataarr = data.split(UTConstants.fileSep);
