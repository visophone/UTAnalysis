...
class DeviceInfo {
    ...
    public static void init(Context context) {
        ...
        try {
            ...
            CobubLog.e(UTConstants.LOG_TAG, DeviceInfo.class, e.toString());
        }
        getLocation();
    }
    ...
    public static String getLanguage() {
        ...
        CobubLog.i(UTConstants.LOG_TAG,    DeviceInfo.class, "getLanguage()=" + language);
        if (language == null)
            return "";
        return language;
    }
...
/**
    ...
    public static String getResolution() {
        ...
        CobubLog.i(UTConstants.LOG_TAG,    DeviceInfo.class, "getResolution()=" + displaysMetrics.widthPixels + "x"
    ...
    public static String getDeviceProduct() {
        ...
        CobubLog.i(UTConstants.LOG_TAG,  DeviceInfo.class,   "getDeviceProduct()=" + result);
        if (result == null)
            return "";
        return result;
    }
    ...
    public static boolean getGravityAvailable() {
        try {
            ...
            CobubLog.i(UTConstants.LOG_TAG,   DeviceInfo.class, "getGravityAvailable()");
    ...
    public static String getOsVersion() {
        ...
        CobubLog.i(UTConstants.LOG_TAG,  DeviceInfo.class,"getOsVersion()=" + result);
        if (result == null)
            return "";
    ...
    public static int getPhoneType() {
        ...
        CobubLog.i(UTConstants.LOG_TAG,   DeviceInfo.class, "getPhoneType()=" + result);
        return result;
    }
    ...
    public static String getIMSI() {
        ...
        try {
            if (!CommonUtil.checkPermissions(context,
                ...
                CobubLog.e(UTConstants.LOG_TAG,  DeviceInfo.class,
                        "READ_PHONE_STATE permission should be added into AndroidManifest.xml.");
                return "";
            }
            result = telephonyManager.getSubscriberId();
            CobubLog.i(UTConstants.LOG_TAG,  DeviceInfo.class, "getIMSI()=" + result);
            if (result == null)
                return "";
            return result;
    ...
    public static String getWifiMac() {
        try {
            ...
            if (result == null)
                result = "";
            CobubLog.i(UTConstants.LOG_TAG,  DeviceInfo.class, "getWifiMac()=" + result);
            return result;
        } catch (Exception e) {
            CobubLog.e(UTConstants.LOG_TAG,  e);
            return "";
    ...
    private static void getLocation() {
        CobubLog.i(UTConstants.LOG_TAG,  DeviceInfo.class, "getLocation");
        try {
