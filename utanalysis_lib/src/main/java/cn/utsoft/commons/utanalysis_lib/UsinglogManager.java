...
class UsinglogManager {
    ...
    JSONObject prepareUsinglogJSON(String start_millis, String end_millis,
        ...
        jsonUsinglog.put("lib_version", UTConstants.LIB_VERSION);

        return jsonUsinglog;
    }
    public void judgeSession(final Context context){
    	CobubLog.i(UTConstants.LOG_TAG,UsinglogManager.class, "Call onResume()");
        try {
    ...
    public void onPause(final Context context) {
        CobubLog.i(UTConstants.LOG_TAG,UsinglogManager.class, "Call onPause()");
